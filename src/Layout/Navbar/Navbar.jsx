  ...
  return (
    ...
    >
      <div className="max-w-[90%] mx-auto">
        <div className=" w-[50%] hidden md:flex items-center justify-between">
              ...
              return (
                <li key={navItem.id} className="relative group overflow-hidden">
                  ...
                  >
                    {navItem.name}
                    <span
                      className={`absolute right-1/2 bottom-0 w-1/2 h-[3px] rounded-full bg-violet-500 transition-all duration-300 ease-in-out group-hover:left-0 group-hover:w-full`}
                    ></span>
                  </NavLink>
                </li>
              );
      ...
      <div className="md:hidden w-full flex justify-between px-4">
        <h1 className="text-2xl text-slate-600 font-bold">
          <Link to={"/"}>EmailPasswordAuth</Link>
        </h1>
